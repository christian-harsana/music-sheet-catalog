        ...
        (
          <>
              ...
              <ul>
                <li className="my-1">
                  <NavLink to="/" className="flex flex-nowrap gap-3 rounded-md px-2.5 py-1 hover:bg-gray-400 [&.active]:bg-violet-500 [&.active:hover]:bg-gray-400">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="15" className="fill-gray-50">
                ...
                <li className="my-1">
                  <NavLink to="/sheet" className="flex flex-nowrap gap-3 rounded-md px-2.5 py-1 hover:bg-gray-400 [&.active]:bg-violet-500 [&.active:hover]:bg-gray-400">
            ...
            <div className="mb-4">
              ...
              <ul>
                <li className="my-1">
                  <NavLink to="/source" className="flex flex-nowrap gap-3 rounded-md px-2.5 py-1 hover:bg-gray-400 [&.active]:bg-violet-500 [&.active:hover]:bg-gray-400">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="15" className="fill-gray-50">
                      {/* !Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc. */}
                ...
                <li className="my-1">
                  <NavLink to="/level" className="flex flex-nowrap gap-3 rounded-md px-2.5 py-1 hover:bg-gray-400 [&.active]:bg-violet-500 [&.active:hover]:bg-gray-400">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="15" className="fill-gray-50">
                      {/* !Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc. */}
                ...
                <li className="my-1">
                  <NavLink to="/genre" className="flex flex-nowrap gap-3 rounded-md px-2.5 py-1 hover:bg-gray-400 [&.active]:bg-violet-500 [&.active:hover]:bg-gray-400">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width="15" className="fill-gray-50">
                      {/* !Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc. */}
              ...
              <ul>
                <li className="my-1">
                  <NavLink to="/profile" className="flex flex-nowrap gap-3 rounded-md px-2.5 py-1 hover:bg-gray-400 [&.active]:bg-violet-500 [&.active:hover]:bg-gray-400">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="15" className="fill-gray-50">
                      {/* !Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc. */}
