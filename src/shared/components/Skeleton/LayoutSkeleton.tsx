export default function LayoutSkeleton() {
    ...
    return(
        <div className="flex flex-col flex-nowrap h-screen lg:flex-row">
            <div className="fixed top-0 left-0 z-20 flex flex-row flex-nowrap justify-between items-center w-full h-14 overflow-hidden bg-gray-950 lg:relative lg:overflow-y-auto lg:flex-col lg:items-start lg:justify-start lg:shrink-0 lg:w-3xs lg:h-full">
