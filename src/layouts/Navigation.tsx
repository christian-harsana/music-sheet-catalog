...
export default function Navigation() {
	...
	return (
		<nav className="h-full lg:w-full">
			...
			<div
				className={`${mobileNavClass} fixed top-14  w-full h-full z-50 px-4 py-5 bg-gray-950 overflow-hidden lg:relative lg:left-0 lg:top-0 lg:px-5 lg:py-0 lg:w-full`}
			>
				{isAuthenticated ? (
					<>
						<div className="mb-4">
							<ul>
								<li className="my-1">
									<NavLink
										to="/"
										className="flex flex-nowrap gap-3 rounded-md px-2.5 py-1 hover:bg-gray-400 [&.active]:bg-violet-500 [&.active:hover]:bg-gray-400"
									>
										<svg
											xmlns="http://www.w3.org/2000/svg"
											viewBox="0 0 512 512"
