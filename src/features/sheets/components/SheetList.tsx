	...
	const showDeleteConfirmation = (id: string, name: string) => {
		showModal(
			<Modal title={'Confirmation'}>
				<DeleteConfirmation id={id} name={name} refreshData={refreshSheets} />
			</Modal>,
		);
	};
				...
				{isLoadingSheet ? (
					...
					sheets.map((sheet) => (
						...
						>
							...
							<td
								role="cell"
								className="block px-3 pb-1 font-semibold before:w-25 before:inline-block before:content-[attr(data-title)':'] before:me-1.5 before:font-normal md:table-cell md:pt-2 md:pb-2 md:before:content-none md:font-normal"
								data-title="Key"
							>
								{sheet.key}
							</td>
							...
							<td
								role="cell"
								className="block px-3 pb-1 font-semibold before:w-25 before:inline-block before:content-[attr(data-title)':'] before:me-1.5 before:font-normal md:table-cell md:pt-2 md:pb-2 md:before:content-none md:font-normal"
								data-title="Exam Piece"
							>
								{sheet.examPiece ? 'Yes' : 'No'}
							</td>
							<td
								role="cell"
								className="block px-3 pb-1 font-semibold before:block before:content-[attr(data-title)':'] before:me-1.5 before:font-normal md:table-cell md:pt-2 md:pb-2 md:before:content-none md:font-normal"
								data-title="Composer"
							>
								{sheet.composer}
							</td>
